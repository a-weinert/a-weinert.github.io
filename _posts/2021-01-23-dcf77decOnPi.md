...
transmitted. Without bad ones we have a chain of true and false only, we 
can put indices respectively second numbers 0 .. 58 on and we can decode.
...
30000 µs. After many experiments (over weeks) we keep it below 10ms.   
 &nbap; &nbsp; ``` testOnPi --glitch 9999 --DCF77 >> logs/dcf77test32cAnG.log & ```
